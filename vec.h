...
public:
	...
	template <class U> friend Vec<U> operator *( const Vec<U>& a, const double d );
	template <class U> friend Vec<U> operator *( const double d, const Vec<U>& a );
	template <class U> friend Vec<U> operator /( const Vec<U>& a, const double d );
	template <class U> friend Vec<U> operator ^( const Vec<U>& a, const Vec<U>& b );
	template <class U> friend bool operator ==( const Vec<U>& a, const Vec<U>& b );
	template <class U> friend bool operator !=( const Vec<U>& a, const Vec<U>& b );
	template <class U> friend ostream& operator <<( ostream& os, const Vec<U>& v );
	template <class U> friend istream& operator >>( istream& is, Vec<U>& v );
	template <class U> friend Vec<U> minimum( const Vec<U>& a, const Vec<U>& b );
	template <class U> friend Vec<U> maximum( const Vec<U>& a, const Vec<U>& b );
	template <class U> friend Vec<U> prod( const Vec<U>& a, const Vec<U>& b );
...
public:
	...
	template<class U> friend bool operator !=( const Vec3<U>& a, const Vec3<U>& b );
	template<class U> friend ostream& operator <<( ostream& os, const Vec3<U>& v );
	template<class U> friend istream& operator >>( istream& is, Vec3<U>& v );
...
public:
	...
	template<class U> friend bool operator !=( const Vec4<U>& a, const Vec4<U>& b );
	template<class U> friend ostream& operator <<( ostream& os, const Vec4<U>& v );
	template<class U> friend istream& operator >>( istream& is, Vec4<U>& v );
	...
	friend istream& operator >>( istream& is, Vec4<T>& v );
...
template <class T>
istream& operator>>( istream& is, const Vec<T>& a ) {
	return is;
}
...
template <class T>
inline istream& operator >>( istream& is, Vec4<T>& v ) {
