...
// Callback function to Frame all
inline void ModelerUserInterface::cb_All_i(Fl_Menu_*, void*) {
	m_modelerView->m_camera->frameAll();
	m_modelerView->redraw();
}
void ModelerUserInterface::cb_All(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->cb_All_i(o,v);
}
...
Fl_Menu_Item ModelerUserInterface::menu_m_controlsMenuBar[] = {
 ...
 {"Frame all", 0,  (Fl_Callback*)ModelerUserInterface::cb_All, 0, 0, 0, 0, 14, 0},
 {0},
